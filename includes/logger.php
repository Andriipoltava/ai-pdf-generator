...
class AIPDF_Logger {
	...
	public function log( string $message, string $level = 'INFO' ): void {
		...
		// The user can turn logging off entirely from Settings; past entries
		// are left in place (still viewable/clearable) — this only gates
		// new writes.
		if ( '1' !== (string) get_option( AIPDF_Plugin::OPTION_LOGGING_ENABLED, '1' ) ) {
			return;
		}
